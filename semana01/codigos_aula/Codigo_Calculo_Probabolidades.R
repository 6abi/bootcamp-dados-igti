...
# A função a seguir gera quantidades aleatórias de sucesso oriundos de umaquantidade (size) de tentativas dada a probabilidade
#(prob) de sucesso. 
...
#########################################
# Exemplo: Uma loja recebe em média, 6 (????) clientes por minuto. Qual a probabilidade  que 5(x) clientes
#entrem em um minuto? dpois(x= 5,lambda = 6)
#Onde:
