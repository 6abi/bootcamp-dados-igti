...
FILE_PATHS = {
    ...
    'cloud':{
        'basics': 'gs://ds-bootcamp_data/data/title_basics.tsv',
        'ratings': 'gs://ds-bootcamp_data/data/title_ratings.tsv',
    }
}
SAVE_PATH = {
    'local': 'data/imdb/title_basics_with_rating',
    'cloud': 'gs://ds-bootcamp_data/data/title_basics_with_rating',
}
